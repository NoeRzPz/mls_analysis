...
ann <- bitr(genes_ceat_leche, fromType = "SYMBOL", toType =  c("SYMBOL","ENSEMBL","ENTREZID"), OrgDb = org.Hs.eg.db)

genes_cebi_atel <- unique(cebi_atel_byFGN$Gene)
# Obtain desired types of IDs from the symbol IDs from significant genes
ann <- bitr(genes_cebi_atel, fromType = "SYMBOL", toType =  c("SYMBOL","ENSEMBL","ENTREZID"), OrgDb = org.Hs.eg.db)
...
# Obtain desired types of IDs from the symbol IDs from significant genes
ann <- bitr(genes_lemu_atel, fromType = "SYMBOL", toType =  c("SYMBOL","ENSEMBL","ENTREZID"), OrgDb = org.Hs.eg.db)

genes_cerco_atel <- unique(cerco_atel_byFGN$Gene)
# Obtain desired types of IDs from the symbol IDs from significant genes
ann <- bitr(genes_cerco_atel, fromType = "SYMBOL", toType =  c("SYMBOL","ENSEMBL","ENTREZID"), OrgDb = org.Hs.eg.db)

genes_cerco_cebi <- unique(cerco_cebi_byFGN$Gene)
# Obtain desired types of IDs from the symbol IDs from significant genes
ann <- bitr(genes_cerco_cebi, fromType = "SYMBOL", toType =  c("SYMBOL","ENSEMBL","ENTREZID"), OrgDb = org.Hs.eg.db)

genes_cerco_lemu <- unique(cerco_lemu_byFGN$Gene)
# Obtain desired types of IDs from the symbol IDs from significant genes
ann <- bitr(genes_cerco_lemu, fromType = "SYMBOL", toType =  c("SYMBOL","ENSEMBL","ENTREZID"), OrgDb = org.Hs.eg.db)
...
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_ceat_leche.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_cebi_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_cebi_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_lemu_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_cerco_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_cerco_cebi.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOBP_cerco_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
...
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_ceat_leche.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_cebi_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_cebi_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_lemu_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_cerco_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_cerco_cebi.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(ego_sign, file.path(resultsDir,"/functional/GOMF_cerco_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
# Convert GeneRatio and BgRatio to numeric and calculate Enrichment Ratio
ego_data <- ego@result %>%
  separate(GeneRatio, into = c("GeneNum", "GeneDenom"), sep = "/") %>%
  separate(BgRatio, into = c("BgNum", "BgDenom"), sep = "/") %>%
...
#write.table(ego_sign, file.path(resultsDir,"/functional/kegg_ceat_leche.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
#write.table(kk_sign, file.path(resultsDir,"/functional/kegg_cebi_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
#write.table(kk_sign, file.path(resultsDir,"/functional/kegg_cebi_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
#write.table(kk_sign, file.path(resultsDir,"/functional/kegg_lemu_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
#write.table(kk_sign, file.path(resultsDir,"/functional/kegg_cerco_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
#write.table(kk_sign, file.path(resultsDir,"/functional/kegg_cerco_cebi.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/kegg_cerco_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
...
write.table(kk_sign, file.path(resultsDir,"/functional/DO_cebi_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DO_cebi_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DO_lemu_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DO_cerco_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DO_cerco_cebi.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DO_cerco_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
...
write.table(kk_sign, file.path(resultsDir,"/functional/DGN_cebi_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DGN_cebi_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DGN_lemu_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DGN_cerco_atel.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DGN_cerco_cebi.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
write.table(kk_sign, file.path(resultsDir,"/functional/DGN_cerco_lemu.txt"), sep = "\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
