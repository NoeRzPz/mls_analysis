...
caas_file=out/functional/cebi_lemu_byFGN.txt
output_coordinates=DATA_RAW_ALIGNMENTS_AND_POSITIONS/coordinates_transvar.tab
gene_equivalences=DATA_RAW_ALIGNMENTS_AND_POSITIONS/proteiID_gene_equivalences.txt
genes=out/functional/genes_cebi_lemu005.tsv
