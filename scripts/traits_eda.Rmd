...
# Store the tree 
famtree <- famtree + geom_nodelab(aes(subset = !is.na(group)), align = TRUE, linetype = "solid")  + coord_fixed(ratio = 15) + theme(plot.margin = unit(c(0, 0, 1, 0), "cm"))
```
...
# Combining the plots
tree_LQdistribution <- plot_grid(famtree, primates_q, rel_widths = c(0.25, 0.75))#ncol=2,
tree_LQdistribution
...
gt::gtsave(table_spp, filename = file.path(resultsDir, "descriptive/topbottom_spp_table.docx"))
```
