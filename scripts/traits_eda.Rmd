...
```{r}
ape::plot.phylo(pruned_primates.tree2)
ape::axisPhylo()  
...
# Combining the plots
combined_plot <- plot_grid(tree_plot, primates1SD, rel_widths = c(0.3, 0.7))#ncol=2,
combined_plot
...
Make scatter plot of LQ vs weight in between in primates database
